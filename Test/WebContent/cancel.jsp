...
<body>
    ...
    <nav class="nav">
        ...
        <ul class="left">
            ...
            <li><a href="login.html"><i class="fa fa-drupal"></i>My Account</a></li>
            <li><a href="register.html"><i class="fa fa-graduation-cap"></i>Register</a></li>
