...
<link href="viewbar.css" rel ="stylesheet"/>
    ...
    <nav class="nav">
        ...
        <ul class="left">
            ...
            <li><a href="#"><i class="fa fa-drupal"></i>My Account</a></li>
...
<p> Your tracking ID is: ${track} Please enter weight for cost: </p>
<div class="login">    
<form method="post" action ="PageCost">
    <fieldset>
    <legend> <i class="fa fa-drupal"></i> Enter weight:</legend>
        Weight:<br><br>
        <input type="number" name="weight" placeholder="Enter weight ..">
        <br><br>
        
        <input type="submit" value="Cost"><br><br>
